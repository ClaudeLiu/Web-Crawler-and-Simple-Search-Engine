...
from datamodel.search.TianzelZiyangc2Zijianx1_datamodel import TianzelZiyangc2Zijianx1Link
...
@Deleter(TianzelZiyangc2Zijianx1Link)
@Getter(TianzelZiyangc2Zijianx1Link)
class DeleteFrontierFrame(IApplication):
    ...
    def update(self):
        ...
        ls = self.frame.get(TianzelZiyangc2Zijianx1Link)
        print "Found ", len(ls), " links to delete."
        for l in ls:
            self.frame.delete(TianzelZiyangc2Zijianx1Link, l)
...
class Simulation(object):
    ...
    def __init__(self, address, port):
        ...
        objectless_connector = ObjectlessSpacetimeConnection(
            "ResetFrontier_TianzelZiyangc2Zijianx1".format(CrawlerFrame.app_id),
